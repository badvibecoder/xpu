...
echo " - Select Recording Format: 'Maktroska"
echo " - Select Audio Encoder: 'libfdk AAC'"
echo " - Select Video Encoder: 'Quicksync H.264'"
echo " - Select Rate Control: 'ICQ' (Level 20)"
echo " - Select Target Usage: 'TU1"
echo " - Select Keyframe Interval: '2 s'"
echo " - Select B-Frames: '3'"
echo "=========================================================="