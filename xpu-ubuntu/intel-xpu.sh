...
sudo docker build -t mrchanche-xpu-torch-jupyter:2.8.10 -f ~/Github/public/system-setup/xpu/torch-dockerfile/Dockerfile .
sudo docker build -t mrchanche-xpu-tensorflow-jupyter:2.15.0 -f ~/Github/public/system-setup/xpu/tensorflow-dockerfile/Dockerfile .
